...
func TestAtan2(t *testing.T) {
	...
	cases := [][3]Uncertain{
		...
		{{0, 1}, {10, 1}, {0, 0.110657221173896}},       //	Atan2({±0, 0}, {x<=-0, ex}) = {±Pi, 0}
		{{0, 0}, {-10, 1}, {math.Pi, 0}},                //	Atan2({±0, 0}, {x<=-0, ex}) = {±Pi, 0}
		{{0, 1}, {-10, 1}, {math.Pi, 3.05093276638905}}, //	Atan2({±0, 0}, {x<=-0, ex}) = {±Pi, 0}

		{{10, 0}, {0, 0}, {math.Pi / 2, 0}},                 //	Atan2({y>0, ey}, {0, 0}) = {+Pi/2, 0}
		{{10, 1}, {0, 1}, {math.Pi / 2, 0.110657221173896}}, //	Atan2({y>0, ey}, {0, 0}) = {+Pi/2, 0}
